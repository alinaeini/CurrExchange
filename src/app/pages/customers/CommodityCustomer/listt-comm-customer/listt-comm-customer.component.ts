...
@Component({
  selector: 'app-listt-comm-customer',
  templateUrl: './listt-comm-customer.component.html',
  styleUrls: ['./listt-comm-customer.component.scss']
})
export class ListtCommCustomerComponent implements OnInit {
  ...
  editFromList(id: string) {
    ...
    this.router.navigate(["customers/edit-customer-comm"], 
    {queryParams: 
            { id: this.Id } 
    }); 
  }
