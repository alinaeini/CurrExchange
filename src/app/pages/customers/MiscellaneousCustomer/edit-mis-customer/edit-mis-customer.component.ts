...
@Component({
  selector: 'app-edit-mis-customer',
  templateUrl: './edit-mis-customer.component.html',
  styleUrls: ['./edit-mis-customer.component.scss']
})
export class EditMisCustomerComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.queryParams.subscribe((param) => {
      this.miscellaneousCustomerService.getCustomerById(param.id).subscribe(res=>{
  ...
  submitCustomerForm() {
    ...
    this.miscellaneousCustomerService.editCustomer(customer).subscribe((res) => {
